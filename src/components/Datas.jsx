...
import { MdOutlineAttachMoney, MdOutlineInventory2, MdOutlineReviews, MdOutlineTextsms } from 'react-icons/md'
import {
	RiFileList3Line,
	RiHeartLine,
	RiImageLine,
...
export const reviewData = [
	...
	},
	{
		...
		user: memberData[2],
		star: 2,
		comment: 'Best product ever this clinic is best for providing the best service. I recommend it',
		reviewAbout: {
	...
	},
	{
		...
		user: memberData[5],
		star: 0,
		comment: 'I use the product but it give me eye problems. I will not use this product again.',
		reviewAbout: {
...
export const convData = [
	...
	},
	{
		...
		text: '',
		time: '01:14 PM',
		imageUrl: 'https://res.cloudinary.com/ds5bmx4ee/image/upload/v1711607745/Eye%20Clinic%20Dashboard/3_hz4vrd.webp',
		value: {
			image: true,
			me: true,
		},
