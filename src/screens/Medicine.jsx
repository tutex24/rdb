...
function Medicine() {
	...
	return (
		<Layout>
			{isOpen && <AddEditMedicineModal datas={data} isOpen={isOpen} closeModal={onCloseModal} />}
			{/* add button */}
			<button
				type="button"
			...
			{/*  */}
			<h1 className="font-semibold text-xl">Medicine</h1>
			<div
				data-aos="fade-up"
			...
			>
				...
				<div className="grid grid-cols-1 gap-2 md:grid-cols-6">
					<div className="grid xs:grid-cols-2 items-center gap-2 md:col-span-5 lg:grid-cols-4">
						...
						/>
						<Select selectedPerson={status} setSelectedPerson={setStatus} datas={sortsDatas.stocks}>
